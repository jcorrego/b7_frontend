<template>
    <div>
        <div v-if="selectedProject" class="rounded-lg shadow">
                ...
                <div v-if="selectedTab == 'new'">
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Add a new work record for the selected project:
...
import AdditionalFilters from '../filters/AdditionalFilters.vue'
    ...
    data() {
        return {
            ...
            tabs: [
                ...
                { name: 'Additional Filters', href: 'search', current: false },
            ],
            selectedTab: 'new',
        }
    },
