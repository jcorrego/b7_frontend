              ...
              <div>
                <MenuButton class="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100">
                  ...
                  <img
                    ...
                    :src="$store.state.loginUser.user.profileImage"
                    alt=""
                  />
                </MenuButton>
              </div>
            ...
            <div class="col-span-2">
              <nav class="flex space-x-4">
                <router-link
                  ...
                  :key="index"
                  :to="option.href"
                  class="text-sm text-sky-100 font-medium rounded-md bg-white bg-opacity-0 px-3 py-2 hover:bg-opacity-10"
                  aria-current="page"
                  exact-active-class="text-white bg-opacity-25"
