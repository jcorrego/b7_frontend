    ...
    <div class="px-4 py-5">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="sm:col-span-2">
          <task-description v-model="taskDescription"></task-description>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            date: new Date(),
            hours: '',
            focalPoint: '', // TODO: Initialize with project default
            comments: '',
            taskDescription: '' // TODO: Initialize with project default
        }
    },
    methods: {
        ...mapActions([
